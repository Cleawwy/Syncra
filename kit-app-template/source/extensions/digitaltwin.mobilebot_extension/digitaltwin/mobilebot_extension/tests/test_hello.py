...
import digitaltwin.mobilebot_extension
...
class Test(omni.kit.test.AsyncTestCaseFailOnLogError):
    ...
    async def test_hello_public_function(self):
        vx, vz, omega = digitaltwin.mobilebot_extension.wheel_to_body_velocity(0.0, 0.0, 0.0)
        self.assertEqual((vx, vz, omega), (0.0, 0.0, 0.0))
